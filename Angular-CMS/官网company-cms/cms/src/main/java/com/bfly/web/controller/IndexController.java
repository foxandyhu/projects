...
public class IndexController extends BaseController {
     ...
     */
    @GetMapping(value = "/{alias}/id_{idStr}")
     ...
     */
    @GetMapping(value = "/article/{channelId}/{pageNo}")
    public String articlePager(HttpServletRequest request,@PathVariable("channelId")int channelId,@PathVariable("pageNo")int pageNo){
        request.setAttribute("channelId", channelId);
        request.setAttribute("pageNo", pageNo);
        return renderTplPath("news.html");
    }
     ...
     */
    @GetMapping(value = "/case/{pageNo}")
    public String casePager(HttpServletRequest request,@PathVariable("pageNo")int pageNo){
        request.setAttribute("pageNo", pageNo);
        return renderTplPath("case.html");
    }
     ...
     * @date 2020/9/13 13:52
     */
    @GetMapping(value = "/site/{pinyin}/case-{pageNo}")
    public String subSiteCasePager(HttpServletRequest request,@PathVariable("pinyin") String pinyin,@PathVariable("pageNo")int pageNo){
        City city = getSubSiteCity(pinyin);
        getRequest().setAttribute("city", city);
        request.setAttribute("pageNo", pageNo);
        return renderTplPath("subsite/case.html");
    }
     ...
     * @date 2020/6/20 19:42
     */
    @GetMapping(value = "/site/{pinyin}/id_{idStr}")
