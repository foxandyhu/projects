...
import com.bfly.trade.annotation.LogRecord;
import com.bfly.trade.enums.RecordType;
...
public class ReflectUtils
{
	 ...
	 * @return
	 */
	public static RecordType getLogRecord(Object obj)
	{
		LogRecord model=null;
		if(obj instanceof Class)
		{
			model=getClassLogRecord((Class<?>)obj);
		}
		else if(obj instanceof Method)
		{
			Method method=(Method)obj;
			model=getMethodLogRecord(method);
		}
		if(model==null)
		{
			return RecordType.REQUIRED;
		}
		return model.record();
	}
	 ...
	 * @return
	 */
	private static LogRecord getClassLogRecord(Class<?> c)
	{
		LogRecord model=c.isAnnotationPresent(LogRecord.class)==false?null:c.getAnnotation(LogRecord.class);
		return model;
	}
	 ...
	 * @return
	 */
	private static LogRecord getMethodLogRecord(Method method)
	{
		LogRecord model=method.isAnnotationPresent(LogRecord.class)==false?null:method.getAnnotation(LogRecord.class);
		return model;
	}
}
