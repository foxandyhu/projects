...
public class Md5PwdEncoder implements PwdEncoder {
	...
	public String encodePassword(String rawPass, String salt) {
		...
		byte[] digest;
		try {
			digest = messageDigest.digest(saltedPass.getBytes(SysConst.ENCODEING_UTF8));
		} catch (UnsupportedEncodingException e) {
			throw new IllegalStateException(SysConst.ENCODEING_UTF8+" not supported!");
		}
	 ...
	 * 混淆码。防止破解。
	 */
	private String defaultSalt=null;
