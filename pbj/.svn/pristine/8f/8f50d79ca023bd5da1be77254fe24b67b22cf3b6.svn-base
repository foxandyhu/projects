define(["jquery","IotApp"],function($,IotApp){
	IotApp.factory("Dialog",function($rootScope,$timeout){
    	var message={
    	...
    	var location={
    			checkLocation:function(){if(window.location.href==window.parent.location.href){window.location.href="";}},
    			forward:function(url){window.location.href=url;},
