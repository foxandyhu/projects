    ...
    <div class="container-fluid">
	    <div class="row header"> 
			...
			<div style="margin-top:10px">  
				<p class="col-xs-6" style="font-size: 12px;color:#ffffff"><span style="margin-left:-10px;float:left;">生长天数${totalDays}天</span></p>
				<p class="col-xs-6" style="font-size: 12px;color:#ffffff"><span style="margin-right:-10px;float:right;">今日步数
				${curStep}步</span>
				</p>
			</div>
	    </div>
		...
		<div class="row tab-content">
		  ...
		  <div class="tab-pane" id="panel1"  style="padding-top:1rem;">
